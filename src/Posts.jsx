            ...
            <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
                {data && data.map((post) => (
                    ...
                    transition-shadow duration-300">
                        <div className="bg-gradient-to-r from-orange-500 to-pink-300 h-3"></div>
                        <div className="p-5">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <button className="text-sm text-white bg-gradient-to-r from-orange-600 to-blue-300 px-3 py-1
