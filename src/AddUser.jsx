            ...
            <div className="bg-white w-1/3 py-5 rounded-2xl shadow">
                ...
                <form className="p-4 rounded-lg shadow-md mb-4">
                    <div className="flex flex-col">
                        ...
                        <input type="text" id="name" name="name" className="p-2 border border-amber-300 rounded" />
                    </div>
                    <div className="flex flex-col mt-4">
                        <label htmlFor="email" className="mb-2 font-medium text-gray-800">ایمیل کاربر</label>
                        <input type="email" id="email" name="email" className="p-2 border border-amber-700 rounded" />
                    </div>
                    <button type="submit" className="mt-4 bg-blue-500 text-white font-medium py-2 px-4 rounded hover:bg-blue-600 transition-colors
                duration-150">افزودن کاربر</button>
                </form>
