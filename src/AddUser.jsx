    ...
    <div className="fixed w-full h-screen left-0 top-0 z-20 bg-black/50 flex justify-center items-center">
      <div className="bg-white w-1/3 py-5 rounded-2xl shadow">
        ...
        <form className="p-4 rounded-lg shadow-md mb-4">
          ...
          <div className="flex flex-col mt-4">
            ...
            <input
              ...
              id="email"
              name="email"
              className="p-2 border border-amber-700 rounded"
            />
          </div>
          <button
            type="submit"
            className="mt-4 bg-blue-500 text-white font-medium py-2 px-4 rounded hover:bg-blue-600 transition-colors
                duration-150"
          >
            افزودن کاربر
          </button>
        ...
        <div className="flex justify-end px-10">
          ...
          <button
            onClick={() => navigate(-1)}
            className="bg-gray-500 text-white rounded py-1 px-2"
          >
            بازگشت
          </button>
        </div>
